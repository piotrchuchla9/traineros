      ...
      {lightbox && (
        ...
        >
          <button
            type="button"
            onClick={() => setLightbox(null)}
            className="cursor-pointer absolute top-4 right-4 w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 transition-colors flex items-center justify-center text-white"
            aria-label="Zamknij"
          >
